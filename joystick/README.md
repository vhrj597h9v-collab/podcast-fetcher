# 6 Button Joystick — parametric model, renders and STL

Thumb-operated joystick with six 6×6×8 mm tactile push buttons wired to a
HiLetgo Pro Micro (ATmega32U4). The buttons sit on a compact 58 × 37 × 34 mm
...
1 mm margins to the rounded edges. Every edge is rounded. Ergonomic curved grip, knurled collar, Ø72 mm base with four M4
...
sit flush in recesses on four M4 countersunk screws. Wires from the six
...
| `out/joystick_button_cap.stl` | one Ø10 × 8 mm cap with a Ø3.6 plunger socket — print 6 |
...
- 6× 6×6×8 mm tactile switches (seat in the 6.8 mm square pockets behind each Ø10.6 hole)
